            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-8">
                <button
                  ...
                  className="text-body-color mb-6 flex w-full items-center justify-center rounded-sm border border-stroke bg-[#f8f8f8] px-6 py-3 text-base outline-none transition-all duration-300 hover:border-black hover:text-black "
                >
                  <span className="mr-3">
                    <svg
                      width="20"
            ...
            <form>
              <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                <input
                  ...
                  className="w-full border-b border-stroke !bg-white pb-3.5 focus:border-waterloo focus:placeholder:text-black focus-visible:outline-none lg:w-1/2"
                />
              ...
              <div className="flex flex-wrap items-center gap-10 md:justify-between xl:gap-15">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2.5 rounded-md bg-blackho px-6 py-3 font-medium text-white duration-300 ease-in-out hover:bg-black"
                >
                  Login
                </button>
              ...
              <div className="mt-12.5 border-t border-stroke py-5 text-center">
                <p>
                  ...
                  <Link
                    className="text-body-color hover:text-blackho"
                    href="/auth/signup"
                  >
                    Sign Up
                  </Link>

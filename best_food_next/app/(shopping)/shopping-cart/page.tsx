            ...
            <div className="bg-white rounded-lg shadow-lg p-0">
              <div className="flex flex-wrap">
                ...
                <div className="w-full lg:w-1/3 bg-gray-100 p-5">
                  ...
                  <div className="mb-5">
                    <div className="relative">
                      <input
                        type="text"
                        id="form3Examplea2"
                        className="border border-gray-300 focus:ring-1 focus:ring-gray-500 focus:border-gray-500 block w-full px-3 py-2 rounded-lg placeholder-gray-400 text-md"
                  ...
                  <button
                    type="button"
                    className="text-black py-3 px-6 rounded-lg shadow-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-opacity-50"
